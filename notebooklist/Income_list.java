...
public class Income_list extends AppCompatActivity {
    ...
    ArrayList<Item> IncomeArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        IncomeWishList = helper.getAllData();
    ...
    /* step:6 create Base Adapter and instantiate the custom list adapter*/
        CustomAdapter adapter = new CustomAdapter(this, incomeArrayList);

    // get the ListView and attach the adapter
        ListView myIncomeWishList  = (ListView) findViewById(R.id.activity_wish_list_item,parent, false);
        myIncomeWishList.setAdapter(adapter);
        ...
        IncomeArrayList=new ArrayList<Item>();
